...
export const verificationButtonStyles = `w-60 md:w-80 group relative flex flex-col items-center justify-center p-3 border-2 border-gray-200 rounded-xl hover:border-[#ff6633] hover:shadow-(--shadow-article) active:shadow-(--shadow-button-active) cursor-pointer duration-300`;
