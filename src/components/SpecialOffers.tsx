      ...
      <div className="mb-4 flex flex-col justify-between text-[#414141] md:mb-8 xl:mb-10">
        <div className="mx-auto flex flex-col gap-4 md:w-184.25 xl:w-full">
          ...
          <div className="flex flex-col items-center gap-4 md:flex-row xl:w-auto">
            ...
            <button className="relative flex h-42.5 w-84 cursor-pointer flex-row overflow-hidden rounded bg-[#FCD5BA] pt-5 pl-5 text-left duration-300 hover:shadow-(--shadow-card-shop) md:w-88 xl:h-50 xl:w-146">
            ...
            <button className="relative h-42.5 w-full cursor-pointer overflow-hidden rounded duration-300 hover:shadow-(--shadow-button-default) md:w-88.25 xl:h-50 xl:w-146">
